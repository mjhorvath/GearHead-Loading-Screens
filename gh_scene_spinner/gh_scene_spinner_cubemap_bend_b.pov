...
#declare max_building_height	= 48;
...
#switch (pov_version)
	...
	#break
#end
#declare light_color = Light_Color(Daylight(5500),4);
...
/*
		#declare city_radius	= city_size.x/pi/2;
		#declare bend_object	= object {#include "CITY.inc"}
		#declare object_axis1	= -x * city_size.x/2;
		#declare object_axis2	= +x * city_size.x/2;
		#declare bend_direction	= +y;
		#declare bend_angle	= 0;
		#include "Bend.inc"
		translate	x * +city_size.x/2
...
//		finish {reflection {1.0} ambient 0 diffuse 0}
	...
	cylinder
	{
		<0,0,-total_length/2,>, <0,0,+total_length/2,>, temp_radius + 1
		open
		hollow
