...
#declare Camera_Translate	= <0,0,-32,>;			//<0,0,-city_size.y,>
...
//------------------------------------------------------------------------------City
...
#if (!NoCity)
	#declare temp_object = object {#include "CITY.inc"}
	#declare temp_union = union
	{
		#local temp_count = 0;
		#while (temp_count < 12)
			object
			{
				temp_object
				translate x * (-block_dist_x * 36/2 + block_dist_x * 3 * temp_count)
			}
	...
	object
	{
		#declare temp_length	= block_dist_x * 36;
		#declare temp_radius	= temp_length/pi/2;
		#declare bend_object	= temp_union;
		#declare object_axis1	= -x * temp_length/2;
		#declare object_axis2	= +x * temp_length/2;
		#declare bend_direction	= +y;
		#declare bend_angle	= 30;
		#include "Bend.inc"
		translate	x * +temp_length/2
